function [evenement] = initialiser2(nb_Ellipsoides,R1,R2,R3)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
angle = GenerateMarchDollase(nb_Ellipsoides, R3);
%angle = -0.1*ones(nb_Ellipsoides,1);
...
% Position + Quaternion
%evenement{4} = [ones(nb_Ellipsoides,3) Quaternion];
evenement{4} = [rand(nb_Ellipsoides,3) Quaternion];
%%
%evenement{5} = [2*ones(nb_Ellipsoides,3)-1,0.2*ones(nb_Ellipsoides,3)-0.1];
