...
namespace blib {
	...
	BLIB_EXPORT void blib::SAP::build(const std::vector<std::shared_ptr<GeometryObject>> & objects, int axis /*= 0*/)
	{
		//Copy and sort
		_array = objects;
	...
	BLIB_EXPORT std::vector<SAP::CollisionPair> SAP::getCollisionPairs() const
	{
